...
{
	// CLA
    final static byte GymCardApplet_CLA =(byte)0xB0;
	...
	**/
	...
	private GymCardApplet(byte[] bArray, short bOffset, byte bLength){
	...
	{
		GymCardApplet wal = new GymCardApplet(bArray, bOffset, bLength);
	}
	...
	public void process(APDU apdu)
	{
		...
		if ((buffer[ISO7816.OFFSET_CLA] == 0) && (buffer[ISO7816.OFFSET_INS] == (byte) 0xA4))
			return;
		if (buffer[ISO7816.OFFSET_CLA] != GymCardApplet_CLA)
